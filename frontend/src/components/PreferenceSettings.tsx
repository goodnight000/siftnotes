    ...
    <div className="space-y-6">
      ...
      <div className="bg-surface rounded-lg border border-border p-6 shadow-sm">
        ...
        <p className="text-sm text-ink-2 mb-6">
          View and access where SiftNotes stores your data
        </p>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 border rounded-lg bg-sunken">
            ...
            <div className="text-sm text-ink-2 mb-3 break-all font-mono text-xs">
        ...
        <div className="mt-4 p-3 bg-wash rounded-md">
