  ...
  if (loading) {
    return (
      <div className="animate-pulse">
        <div className="h-4 bg-sunken rounded w-1/4 mb-4"></div>
        <div className="h-8 bg-sunken rounded mb-4"></div>
      </div>
    );
  }
      ...
      {preferences.auto_save && (
        <div className="space-y-4">
          <div className="p-4 border rounded-lg bg-sunken">
            ...
            <div className="text-sm text-ink-2 mb-3 break-all">
              {preferences.save_folder || 'Default folder'}
            </div>
            <button
              onClick={handleOpenFolder}
              className="flex items-center gap-2 px-3 py-2 text-sm border border-border rounded-md hover:bg-sunken transition-colors"
            >
          ...
          <div className="p-4 border border-border rounded-lg bg-wash">
            <div className="text-sm text-ink-2">
