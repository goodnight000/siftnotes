      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-ink-3">{modelSize}</p>
          </div>
        </div>
        <div>
          {state.status === 'waiting' && (
            <span className="text-sm text-ink-3">Waiting...</span>
          )}
        ...
        <div className="mt-2 p-3 bg-red-50 border border-red-200 rounded-md">
          ...
          {(title === 'Transcription Engine' || title === 'Summary Engine') && (
            <button
              ...
              className="mt-3 w-full h-9 px-4 bg-primary text-primary-foreground hover:opacity-90 text-sm font-medium rounded-md transition-colors flex items-center justify-center gap-2"
            >
      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        <AnimatePresence>
          {setupMode === 'local' && parakeetDownloaded && !summaryModelDownloaded && (
            <motion.div
              ...
              className="w-full max-w-lg bg-sunken rounded-lg p-4 text-sm text-ink-2"
            >
              <div className="flex items-start gap-3">
                <Download className="w-5 h-5 text-ink-2 flex-shrink-0 mt-0.5" />
                <div>
        ...
        <div className="w-full max-w-xs">
          <Button
            ...
            className="w-full h-11 bg-primary text-primary-foreground hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
          >
